...
export const initialChats: Chat[] = [
  {
    ...
    messages: [
      ...
      },
      {
        ...
        role: "assistant",
        content:
          "Hello Jane! Common symptoms of the flu (influenza) include fever, chills, muscle aches, cough, congestion, runny nose, headaches, and fatigue. If you are experiencing these, getting plenty of rest and staying hydrated is recommended. Would you like me to elaborate on when to see a doctor?",
