...
export default function ChatIdPage({
  ...
  return (
    <>
      ...
      <div className="z-10 flex h-14 shrink-0 items-center border-b border-border/40 bg-background/95 px-4 backdrop-blur supports-[backdrop-filter]:bg-background/60">
